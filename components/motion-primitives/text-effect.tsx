...
const defaultContainerVariants: Variants = {
  ...
  visible: {
    ...
    transition: {
      ...
      duration: 3, // Add duration to control the transition time
    },
  },
  exit: {
...
const defaultItemVariants: Variants = {
  ...
  visible: {
    opacity: 1,
    transition: {
      repeat: Infinity, // Make the item animation repeat infinitely
      repeatType: "loop", // Loop the item animation continuously
      ease: "easeInOut", // Smooth ease-in-out transition
      duration: 3, // Add duration to control the transition time
    },
  },
